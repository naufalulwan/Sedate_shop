...
<div id="breadcrumb">
	<div class="container">
		<ul class="breadcrumb">
			...
			<li class="active">Pesanan Pelanggan</li>
		</ul>
	</div>
</div>
<!-- /BREADCRUMB -->
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<small class="text-muted">
								Semua data pesanan / Faktur anda.
							</small>
							<br/>
							<br/>
											...
											<tr>
												...
												<td class="text-center">
													...
													if($i['invoice_status'] == 0){
														...
														<a class='btn btn-sm btn-primary' href="customer_pembayaran.php?id=<?php echo $i['invoice_id']; ?>"><i class="fa fa-money"></i> Konfirmasi Pembayaran</a>
														<?php } ?>
													<a class='btn btn-sm btn-success' href="customer_invoice.php?id=<?php echo $i['invoice_id']; ?>"><i class="fa fa-print"></i> Faktur</a>
												</td>
											</tr>
											<?php } ?>
									</tbody>
